<?php 
    /* Template Name: Woo Cart Template */
    get_header();
?>
...
<section class="woo-cart-container">
    <div class="container">
        ...
        <div class="title text-align-center">
            ...
            <p>Request a call with a learning solutions specialist to create a bespoke learning package tailored for
                        ...
                        <td colspan="6" class="actions">
                            ...
                            <div class="coupon">
                                ...
                                <input type="text" name="coupon_code" class="input-text" id="coupon_code" value=""
                                    ...
                                    type="submit"
                                    class="button siteCTA no-arrow cartCTA<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>"
                                    name="apply_coupon"
